        ...
        <section className="container mx-auto px-6 text-center">
          <div className="border border-white/10 bg-white/5 rounded-3xl p-12 md:p-20 relative overflow-hidden">
            ...
            <p className="text-zinc-400 text-lg mb-10 max-w-xl mx-auto relative z-10">
              Join thousands of developers and designers who use Excalidraw to communicate their ideas.
            </p>
            <Link 
              href="/signup" 
              className="relative z-10 inline-flex items-center gap-2 bg-white text-black px-8 py-4 rounded-full font-bold text-lg hover:bg-zinc-200 transition-colors"
            >
